...
echo "Ad hoc signed, unnotarized Mac build: $archive"
echo "Public download requires clear manual Open Anyway instructions; do not describe this build as Apple verified."
